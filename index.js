...
//connection
const uri = `mongodb+srv://baundule_travellers:jyxXIRu5oAp3b0YS@cluster0.up1ogs2.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const database = client.db('baundule_travellers');
...
app.get('/', (req, res) => {
  res.send('Baundule Server Running');
});
